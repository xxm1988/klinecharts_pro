...
var d5 = (e, t, n) => t in e ? h5(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var p1 = (e, t, n) => (d5(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as P, init as y5, FormatDateType as Q1, DomPosition as j0, ActionType as m5, dispose as p5, TooltipIconPosition as R1, registerOverlay as v5 } from "klinecharts";
function B1(e, t, n) {
...
const _5 = {
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = w9(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = P.getLinearSlopeIntercept(e[0], e[1]);
      let i;
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((u) => {
        ...
        n.push({ coordinates: [{ x: d, y: e[0].y }, { x: d, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: p }, { x: e[1].x, y: p }] }), r = r.concat(y0([e[0], { x: d, y: e[1].y }], t)), r = r.concat(y0([e[0], { x: e[1].x, y: p }], t)), a.unshift({
          x: e[0].x + i,
          y: p + 10,
          text: `${u.toFixed(3)}`
        }), a.unshift({
...
const K5 = (e, t) => e === t, m0 = Symbol("solid-proxy"), j5 = Symbol("solid-track"), G1 = {
  equals: K5
};
let M9 = D9;
const o1 = 1, X1 = 2, S9 = {
...
var R = null;
let h1 = null, N = null, Y = null, i1 = null, k0 = 0;
function V1(e, t) {
  const n = N, r = R, a = e.length === 0, i = a ? S9 : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? r : t
...
function K(e, t, n) {
  n = n ? Object.assign({}, G1, n) : G1;
  const r = a0(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, _1(r), I9.bind(r);
}
function Z5(e, t, n) {
  let r, a, i;
  arguments.length === 2 && typeof t == "object" || arguments.length === 1 ? (r = !0, a = e, i = t || {}) : (r = e, a = t, i = n || {});
  let o = null, s = f0, c = null, C = !1, u = "initialValue" in i, d = typeof r == "function" && K(r);
...
function N9(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && u1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      ...
      o && h1.disposed.has(i), (o && !i.tState || !o && !i.state) && (i.pure ? Y.push(i) : i1.push(i), i.observers && P9(i)), o || (i.state = o1);
    }
    if (Y.length > 1e6)
      throw Y = [], new Error();
  }, !1)), t;
...
function a0(e, t, n, r = o1, a) {
  ...
  return R === null || R !== S9 && (R.owned ? R.owned.push(i) : R.owned = [i]), i;
}
function J1(e) {
  const t = h1;
  if (e.state === 0 || t)
  ...
  const n = [e];
  for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < k0); )
    (e.state || t) && n.push(e);
  for (let r = n.length - 1; r >= 0; r--)
    if (e = n[r], e.state === o1 || t)
      _1(e);
    else if (e.state === X1 || t) {
      const a = Y;
      Y = null, u1(() => W1(e, n[0]), !1), Y = a;
    }
}
function u1(e, t) {
  if (Y)
...
function W1(e, t) {
  ...
  for (let r = 0; r < e.sources.length; r += 1) {
    const a = e.sources[r];
    a.sources && (a.state === o1 || n ? a !== t && J1(a) : (a.state === X1 || n) && W1(a, t));
  }
}
function P9(e) {
  const t = h1;
  for (let n = 0; n < e.observers.length; n += 1) {
    ...
    (!r.state || t) && (r.state = X1, r.pure ? Y.push(r) : i1.push(r), r.observers && P9(r));
  }
}
function i0(e) {
  let t;
...
function H5(e, t, n = {}) {
  ...
  return A0(() => Q0(i)), () => {
    ...
    return c[j5], s1(() => {
      ...
      if (p === 0)
        o !== 0 && (Q0(i), i = [], r = [], a = [], o = 0, s && (s = [])), n.fallback && (r = [V5], a[0] = V1((O) => (i[0] = O, n.fallback())), o = 1);
      else if (o === 0) {
        ...
        for (u = Q; u < p; u++)
          u in B ? (a[u] = B[u], i[u] = F[u], s && (s[u] = M[u], s[u](u))) : a[u] = V1(d);
...
function E9(...e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const a = e[r];
    t = t || !!a && m0 in a, e[r] = typeof a == "function" ? (t = !0, K(a)) : a;
  }
  if (t)
    return new Proxy({
      get(r) {
...
function X5(e) {
  ...
  return K(H5(() => e.each, e.children, t || void 0));
}
function U(e) {
  let t = !1;
...
function q(e, t = window.document) {
  ...
  for (let r = 0, a = e.length; r < a; r++) {
    const i = e[r];
    n.has(i) || (n.add(i), t.addEventListener(i, q5));
  }
}
function G(e, t, n) {
  ...
  if (e = o && n[0] && n[0].parentNode || e, i === "string" || i === "number") {
    ...
    if (Array.isArray(t)) {
      ...
      if (s.length === 0) {
        ...
        c ? n.length === 0 ? z0(e, s, r) : J5(e, n, s) : (n && v1(e), z0(e, s));
      n = s;
    ...
    if (s instanceof Node)
      ...
      if (Array.isArray(s))
        ...
        if (r) {
          for (; typeof s == "function"; )
            s = s();
          a = p0(e, Array.isArray(s) ? s : [s], Array.isArray(c) ? c : [c]) || a;
        } else
          e.push(s), a = !0;
      else {
        const C = String(s);
...
var e6 = typeof U1 == "object" && U1 && U1.Object === Object && U1, K9 = e6, t6 = K9, n6 = typeof self == "object" && self && self.Object === Object && self, r6 = t6 || n6 || Function("return this")(), e1 = r6, a6 = e1, i6 = a6.Symbol, s0 = i6, U0 = s0, j9 = Object.prototype, s6 = j9.hasOwnProperty, o6 = j9.toString, P1 = U0 ? U0.toStringTag : void 0;
function c6(e) {
  var t = s6.call(e, P1), n = e[P1];
  try {
    e[P1] = void 0;
    var r = !0;
  } catch {
...
var l6 = c6, u6 = Object.prototype, C6 = u6.toString;
function f6(e) {
  return C6.call(e);
}
var g6 = f6, Y0 = s0, h6 = l6, d6 = g6, y6 = "[object Null]", m6 = "[object Undefined]", V0 = Y0 ? Y0.toStringTag : void 0;
function p6(e) {
  return e == null ? e === void 0 ? m6 : y6 : V0 && V0 in Object(e) ? h6(e) : d6(e);
}
var O1 = p6;
function v6(e) {
  var t = typeof e;
...
var $1 = v6, _6 = O1, L6 = $1, $6 = "[object AsyncFunction]", b6 = "[object Function]", x6 = "[object GeneratorFunction]", k6 = "[object Proxy]";
function A6(e) {
  if (!L6(e))
    return !1;
  var t = _6(e);
  return t == b6 || t == x6 || t == $6 || t == k6;
}
var Z9 = A6, w6 = e1, M6 = w6["__core-js_shared__"], S6 = M6, h0 = S6, H0 = function() {
...
var I6 = T6, N6 = Function.prototype, D6 = N6.toString;
function P6(e) {
  if (e != null) {
    try {
      return D6.call(e);
...
var Q9 = P6, B6 = Z9, O6 = I6, E6 = $1, F6 = Q9, K6 = /[\\^$.*+?()[\]{}|]/g, j6 = /^\[object .+?Constructor\]$/, Z6 = Function.prototype, Q6 = Object.prototype, R6 = Z6.toString, z6 = Q6.hasOwnProperty, U6 = RegExp(
  "^" + R6.call(z6).replace(K6, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Y6(e) {
  if (!E6(e) || O6(e))
    return !1;
...
var G6 = H6, X6 = V6, J6 = G6;
function W6(e, t) {
  var n = J6(e, t);
  return X6(n) ? n : void 0;
}
var y1 = W6, q6 = y1, ee = function() {
  try {
...
var z9 = re, ae = R9, ie = z9, se = Object.prototype, oe = se.hasOwnProperty;
function ce(e, t, n) {
  var r = e[t];
  (!(oe.call(e, t) && ie(r, n)) || n === void 0 && !(t in e)) && ae(e, t, n);
}
var M0 = ce, le = Array.isArray, b1 = le;
function ue(e) {
  return e != null && typeof e == "object";
}
var x1 = ue, Ce = O1, fe = x1, ge = "[object Symbol]";
function he(e) {
  return typeof e == "symbol" || fe(e) && Ce(e) == ge;
}
var S0 = he, de = b1, ye = S0, me = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, pe = /^\w*$/;
function ve(e, t) {
  if (de(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || ye(e) ? !0 : pe.test(e) || !me.test(e) || t != null && e in Object(t);
}
var _e = ve, Le = y1, $e = Le(Object, "create"), o0 = $e, X0 = o0;
function be() {
...
var Ae = ke, we = o0, Me = "__lodash_hash_undefined__", Se = Object.prototype, Te = Se.hasOwnProperty;
function Ie(e) {
  var t = this.__data__;
  if (we) {
    var n = t[e];
...
var Ne = Ie, De = o0, Pe = Object.prototype, Be = Pe.hasOwnProperty;
function Oe(e) {
  var t = this.__data__;
  return De ? t[e] !== void 0 : Be.call(t, e);
}
var Ee = Oe, Fe = o0, Ke = "__lodash_hash_undefined__";
function je(e, t) {
  var n = this.__data__;
  return this.size += this.has(e) ? 0 : 1, n[e] = Fe && t === void 0 ? Ke : t, this;
}
var Ze = je, Qe = xe, Re = Ae, ze = Ne, Ue = Ee, Ye = Ze;
function k1(e) {
...
k1.prototype.clear = Qe;
k1.prototype.delete = Re;
k1.prototype.get = ze;
k1.prototype.has = Ue;
k1.prototype.set = Ye;
var Ve = k1;
...
var c0 = Je, We = c0, qe = Array.prototype, e2 = qe.splice;
function t2(e) {
  var t = this.__data__, n = We(t, e);
  if (n < 0)
    return !1;
  var r = t.length - 1;
  return n == r ? t.pop() : e2.call(t, n, 1), --this.size, !0;
}
var n2 = t2, r2 = c0;
function a2(e) {
  var t = this.__data__, n = r2(t, e);
  return n < 0 ? void 0 : t[n][1];
}
var i2 = a2, s2 = c0;
function o2(e) {
  return s2(this.__data__, e) > -1;
}
var c2 = o2, l2 = c0;
function u2(e, t) {
...
var C2 = u2, f2 = Ge, g2 = n2, h2 = i2, d2 = c2, y2 = C2;
function A1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
A1.prototype.clear = f2;
A1.prototype.delete = g2;
A1.prototype.get = h2;
A1.prototype.has = d2;
A1.prototype.set = y2;
var l0 = A1, m2 = y1, p2 = e1, v2 = m2(p2, "Map"), T0 = v2, J0 = Ve, _2 = l0, L2 = T0;
function $2() {
...
function w2(e, t) {
  var n = e.__data__;
  return A2(t) ? n[typeof t == "string" ? "string" : "hash"] : n.map;
}
var u0 = w2, M2 = u0;
function S2(e) {
  var t = M2(this, e).delete(e);
  return this.size -= t ? 1 : 0, t;
}
var T2 = S2, I2 = u0;
function N2(e) {
...
var K2 = F2, j2 = b2, Z2 = T2, Q2 = D2, R2 = O2, z2 = K2;
function w1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
w1.prototype.delete = Z2;
w1.prototype.get = Q2;
w1.prototype.has = R2;
w1.prototype.set = z2;
var U9 = w1, Y9 = U9, U2 = "Expected a function";
function I0(e, t) {
  ...
  return n.cache = new (I0.Cache || Y9)(), n;
}
I0.Cache = Y9;
var Y2 = I0, V2 = Y2, H2 = 500;
function G2(e) {
  var t = V2(e, function(r) {
    return n.size === H2 && n.clear(), r;
  }), n = t.cache;
  return t;
}
var X2 = G2, J2 = X2, W2 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, q2 = /\\(\\)?/g, e3 = J2(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(W2, function(n, r, a, i) {
    t.push(a ? i.replace(q2, "$1") : r || n);
  }), t;
}), t3 = e3;
function n3(e, t) {
...
var r3 = n3, W0 = s0, a3 = r3, i3 = b1, s3 = S0, o3 = 1 / 0, q0 = W0 ? W0.prototype : void 0, e9 = q0 ? q0.toString : void 0;
function V9(e) {
  if (typeof e == "string")
    return e;
  if (i3(e))
  ...
  if (s3(e))
    return e9 ? e9.call(e) : "";
  var t = e + "";
  return t == "0" && 1 / e == -o3 ? "-0" : t;
}
var c3 = V9, l3 = c3;
function u3(e) {
  return e == null ? "" : l3(e);
}
var C3 = u3, f3 = b1, g3 = _e, h3 = t3, d3 = C3;
function y3(e, t) {
  return f3(e) ? e : g3(e, t) ? [e] : h3(d3(e));
}
var m3 = y3, p3 = 9007199254740991, v3 = /^(?:0|[1-9]\d*)$/;
function _3(e, t) {
  var n = typeof e;
  return t = t ?? p3, !!t && (n == "number" || n != "symbol" && v3.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var H9 = _3, L3 = S0, $3 = 1 / 0;
function b3(e) {
  if (typeof e == "string" || L3(e))
    return e;
  var t = e + "";
  return t == "0" && 1 / e == -$3 ? "-0" : t;
}
var x3 = b3, k3 = M0, A3 = m3, w3 = H9, t9 = $1, M3 = x3;
function S3(e, t, n, r) {
  if (!t9(e))
    return e;
  t = A3(t, e);
  for (var a = -1, i = t.length, o = i - 1, s = e; s != null && ++a < i; ) {
    ...
    if (a != o) {
      var u = s[c];
      C = r ? r(u, c, s) : void 0, C === void 0 && (C = t9(u) ? u : w3(t[a + 1]) ? [] : {});
    }
    k3(s, c, C), s = s[c];
  }
  return e;
...
var Q3 = Z3, R3 = l0, z3 = T0, U3 = U9, Y3 = 200;
function V3(e, t) {
  var n = this.__data__;
  if (n instanceof R3) {
    var r = n.__data__;
    ...
    n = this.__data__ = new U3(r);
  }
  return n.set(e, t), this.size = n.size, this;
}
var H3 = V3, G3 = l0, X3 = O3, J3 = F3, W3 = j3, q3 = Q3, e8 = H3;
function M1(e) {
  var t = this.__data__ = new G3(e);
  this.size = t.size;
}
M1.prototype.clear = X3;
M1.prototype.delete = J3;
M1.prototype.get = W3;
M1.prototype.has = q3;
M1.prototype.set = e8;
var t8 = M1;
...
var r8 = n8, a8 = M0, i8 = R9;
function s8(e, t, n, r) {
  var a = !n;
  n || (n = {});
  for (var i = -1, o = t.length; ++i < o; ) {
    var s = t[i], c = r ? r(n[s], e[s], s, n, e) : void 0;
    c === void 0 && (c = e[s]), a ? i8(n, s, c) : a8(n, s, c);
  }
  return n;
}
var C0 = s8;
...
var c8 = o8, l8 = O1, u8 = x1, C8 = "[object Arguments]";
function f8(e) {
  return u8(e) && l8(e) == C8;
}
var g8 = f8, n9 = g8, h8 = x1, G9 = Object.prototype, d8 = G9.hasOwnProperty, y8 = G9.propertyIsEnumerable, m8 = n9(function() {
  return arguments;
}()) ? n9 : function(e) {
  return h8(e) && d8.call(e, "callee") && !y8.call(e, "callee");
}, p8 = m8, e0 = { exports: {} };
function v8() {
  return !1;
}
...
e0.exports;
(function(e, t) {
  var n = e1, r = _8, a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, s = o ? n.Buffer : void 0, c = s ? s.isBuffer : void 0, C = c || r;
  e.exports = C;
})(e0, e0.exports);
var X9 = e0.exports, L8 = 9007199254740991;
function $8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= L8;
}
var J9 = $8, b8 = O1, x8 = J9, k8 = x1, A8 = "[object Arguments]", w8 = "[object Array]", M8 = "[object Boolean]", S8 = "[object Date]", T8 = "[object Error]", I8 = "[object Function]", N8 = "[object Map]", D8 = "[object Number]", P8 = "[object Object]", B8 = "[object RegExp]", O8 = "[object Set]", E8 = "[object String]", F8 = "[object WeakMap]", K8 = "[object ArrayBuffer]", j8 = "[object DataView]", Z8 = "[object Float32Array]", Q8 = "[object Float64Array]", R8 = "[object Int8Array]", z8 = "[object Int16Array]", U8 = "[object Int32Array]", Y8 = "[object Uint8Array]", V8 = "[object Uint8ClampedArray]", H8 = "[object Uint16Array]", G8 = "[object Uint32Array]", I = {};
I[Z8] = I[Q8] = I[R8] = I[z8] = I[U8] = I[Y8] = I[V8] = I[H8] = I[G8] = !0;
I[A8] = I[w8] = I[K8] = I[M8] = I[j8] = I[S8] = I[T8] = I[I8] = I[N8] = I[D8] = I[P8] = I[B8] = I[O8] = I[E8] = I[F8] = !1;
function X8(e) {
  return k8(e) && x8(e.length) && !!I[b8(e)];
}
var J8 = X8;
function W8(e) {
  return function(t) {
...
var N0 = W8, t0 = { exports: {} };
t0.exports;
(function(e, t) {
  var n = K9, r = t && !t.nodeType && t, a = r && !0 && e && !e.nodeType && e, i = a && a.exports === r, o = i && n.process, s = function() {
    try {
...
var D0 = t0.exports, q8 = J8, e7 = N0, r9 = D0, a9 = r9 && r9.isTypedArray, t7 = a9 ? e7(a9) : q8, n7 = t7, r7 = c8, a7 = p8, i7 = b1, s7 = X9, o7 = H9, c7 = n7, l7 = Object.prototype, u7 = l7.hasOwnProperty;
function C7(e, t) {
...
var q9 = h7, d7 = q9, y7 = d7(Object.keys, Object), m7 = y7, p7 = P0, v7 = m7, _7 = Object.prototype, L7 = _7.hasOwnProperty;
function $7(e) {
  if (!p7(e))
    return v7(e);
  var t = [];
...
var b7 = $7, x7 = Z9, k7 = J9;
function A7(e) {
  return e != null && k7(e.length) && !x7(e);
}
var e5 = A7, w7 = W9, M7 = b7, S7 = e5;
function T7(e) {
  return S7(e) ? w7(e) : M7(e);
}
var B0 = T7, I7 = C0, N7 = B0;
function D7(e, t) {
...
var O7 = B7, E7 = $1, F7 = P0, K7 = O7, j7 = Object.prototype, Z7 = j7.hasOwnProperty;
function Q7(e) {
  if (!E7(e))
    return K7(e);
  var t = F7(e), n = [];
...
var R7 = Q7, z7 = W9, U7 = R7, Y7 = e5;
function V7(e) {
  return Y7(e) ? z7(e, !0) : U7(e);
}
var O0 = V7, H7 = C0, G7 = O0;
function X7(e, t) {
  return e && H7(t, G7(t), e);
}
var J7 = X7, n0 = { exports: {} };
n0.exports;
(function(e, t) {
...
var t5 = rt, at = nt, it = t5, st = Object.prototype, ot = st.propertyIsEnumerable, i9 = Object.getOwnPropertySymbols, ct = i9 ? function(e) {
  return e == null ? [] : (e = Object(e), at(i9(e), function(t) {
    return ot.call(e, t);
  }));
} : it, E0 = ct, lt = C0, ut = E0;
function Ct(e, t) {
  return lt(e, ut(e), t);
}
var ft = Ct;
...
var n5 = gt, ht = q9, dt = ht(Object.getPrototypeOf, Object), r5 = dt, yt = n5, mt = r5, pt = E0, vt = t5, _t = Object.getOwnPropertySymbols, Lt = _t ? function(e) {
  for (var t = []; e; )
    yt(t, pt(e)), e = mt(e);
  return t;
} : vt, a5 = Lt, $t = C0, bt = a5;
...
var kt = xt, At = n5, wt = b1;
function Mt(e, t, n) {
  var r = t(e);
  return wt(e) ? r : At(r, n(e));
}
var i5 = Mt, St = i5, Tt = E0, It = B0;
function Nt(e) {
  return St(e, It, Tt);
}
var Dt = Nt, Pt = i5, Bt = a5, Ot = O0;
function Et(e) {
  return Pt(e, Ot, Bt);
}
var Ft = Et, Kt = y1, jt = e1, Zt = Kt(jt, "DataView"), Qt = Zt, Rt = y1, zt = e1, Ut = Rt(zt, "Promise"), Yt = Ut, Vt = y1, Ht = e1, Gt = Vt(Ht, "Set"), Xt = Gt, Jt = y1, Wt = e1, qt = Jt(Wt, "WeakMap"), e4 = qt, _0 = Qt, L0 = T0, $0 = Yt, b0 = Xt, x0 = e4, s5 = O1, S1 = Q9, s9 = "[object Map]", t4 = "[object Object]", o9 = "[object Promise]", c9 = "[object Set]", l9 = "[object WeakMap]", u9 = "[object DataView]", n4 = S1(_0), r4 = S1(L0), a4 = S1($0), i4 = S1(b0), s4 = S1(x0), g1 = s5;
(_0 && g1(new _0(new ArrayBuffer(1))) != u9 || L0 && g1(new L0()) != s9 || $0 && g1($0.resolve()) != o9 || b0 && g1(new b0()) != c9 || x0 && g1(new x0()) != l9) && (g1 = function(e) {
  var t = s5(e), n = t == t4 ? e.constructor : void 0, r = n ? S1(n) : "";
  if (r)
    switch (r) {
      case n4:
        return u9;
...
var F0 = g1, o4 = Object.prototype, c4 = o4.hasOwnProperty;
function l4(e) {
  var t = e.length, n = new e.constructor(t);
  return t && typeof e[0] == "string" && c4.call(e, "index") && (n.index = e.index, n.input = e.input), n;
}
var u4 = l4, C4 = e1, f4 = C4.Uint8Array, g4 = f4, C9 = g4;
function h4(e) {
...
var m4 = y4, p4 = /\w*$/;
function v4(e) {
  var t = new e.constructor(e.source, p4.exec(e));
  return t.lastIndex = e.lastIndex, t;
}
var _4 = v4, f9 = s0, g9 = f9 ? f9.prototype : void 0, h9 = g9 ? g9.valueOf : void 0;
function L4(e) {
  return h9 ? Object(h9.call(e)) : {};
}
var $4 = L4, b4 = K0;
function x4(e, t) {
  var n = t ? b4(e.buffer) : e.buffer;
  return new e.constructor(n, e.byteOffset, e.length);
}
var k4 = x4, A4 = K0, w4 = m4, M4 = _4, S4 = $4, T4 = k4, I4 = "[object Boolean]", N4 = "[object Date]", D4 = "[object Map]", P4 = "[object Number]", B4 = "[object RegExp]", O4 = "[object Set]", E4 = "[object String]", F4 = "[object Symbol]", K4 = "[object ArrayBuffer]", j4 = "[object DataView]", Z4 = "[object Float32Array]", Q4 = "[object Float64Array]", R4 = "[object Int8Array]", z4 = "[object Int16Array]", U4 = "[object Int32Array]", Y4 = "[object Uint8Array]", V4 = "[object Uint8ClampedArray]", H4 = "[object Uint16Array]", G4 = "[object Uint32Array]";
function X4(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case K4:
...
var J4 = X4, W4 = $1, d9 = Object.create, q4 = function() {
  function e() {
  }
  return function(t) {
    if (!W4(t))
...
}(), en = q4, tn = en, nn = r5, rn = P0;
function an(e) {
  return typeof e.constructor == "function" && !rn(e) ? tn(nn(e)) : {};
}
var sn = an, on = F0, cn = x1, ln = "[object Map]";
function un(e) {
  return cn(e) && on(e) == ln;
}
var Cn = un, fn = Cn, gn = N0, y9 = D0, m9 = y9 && y9.isMap, hn = m9 ? gn(m9) : fn, dn = hn, yn = F0, mn = x1, pn = "[object Set]";
function vn(e) {
  return mn(e) && yn(e) == pn;
}
var _n = vn, Ln = _n, $n = N0, p9 = D0, v9 = p9 && p9.isSet, bn = v9 ? $n(v9) : Ln, xn = bn, kn = t8, An = r8, wn = M0, Mn = P7, Sn = J7, Tn = W7, In = et, Nn = ft, Dn = kt, Pn = Dt, Bn = Ft, On = F0, En = u4, Fn = J4, Kn = sn, jn = b1, Zn = X9, Qn = dn, Rn = $1, zn = xn, Un = B0, Yn = O0, Vn = 1, Hn = 2, Gn = 4, o5 = "[object Arguments]", Xn = "[object Array]", Jn = "[object Boolean]", Wn = "[object Date]", qn = "[object Error]", c5 = "[object Function]", er = "[object GeneratorFunction]", tr = "[object Map]", nr = "[object Number]", l5 = "[object Object]", rr = "[object RegExp]", ar = "[object Set]", ir = "[object String]", sr = "[object Symbol]", or = "[object WeakMap]", cr = "[object ArrayBuffer]", lr = "[object DataView]", ur = "[object Float32Array]", Cr = "[object Float64Array]", fr = "[object Int8Array]", gr = "[object Int16Array]", hr = "[object Int32Array]", dr = "[object Uint8Array]", yr = "[object Uint8ClampedArray]", mr = "[object Uint16Array]", pr = "[object Uint32Array]", T = {};
T[o5] = T[Xn] = T[cr] = T[lr] = T[Jn] = T[Wn] = T[ur] = T[Cr] = T[fr] = T[gr] = T[hr] = T[tr] = T[nr] = T[l5] = T[rr] = T[ar] = T[ir] = T[sr] = T[dr] = T[yr] = T[mr] = T[pr] = !0;
T[qn] = T[c5] = T[or] = !1;
function H1(e, t, n, r, a, i) {
  var o, s = t & Vn, c = t & Hn, C = t & Gn;
  ...
  if (u) {
    ...
    var d = On(e), p = d == c5 || d == er;
    if (Zn(e))
      return Tn(e, s);
    if (d == l5 || d == o5 || p && !a) {
      if (o = c || p ? {} : Kn(e), !s)
        return c ? Dn(e, Sn(o, e)) : Nn(e, Mn(o, e));
    } else {
      if (!T[d])
        return a ? e : {};
      o = Fn(e, d, s);
  ...
  if (L)
    return L;
  i.set(e, o), zn(e) ? e.forEach(function(F) {
    o.add(H1(F, t, n, F, e, i));
  }) : Qn(e) && e.forEach(function(F, M) {
    o.set(M, H1(F, t, n, M, e, i));
  });
  var w = C ? c ? Bn : Pn : c ? Yn : Un, B = u ? void 0 : w(e);
  return An(B || e, function(F, M) {
    B && (M = F, F = e[M]), wn(o, M, H1(F, t, n, M, e, i));
  }), o;
}
var vr = H1, _r = vr, Lr = 1, $r = 4;
function br(e) {
  return _r(e, Lr | $r);
}
var xr = br;
const kr = /* @__PURE__ */ F9(xr), Ar = /* @__PURE__ */ g("<button></button>"), wr = (e) => (() => {
  ...
  return l1(t, "click", e.onClick, !0), m(t, () => e.children), Z((n) => {
    ...
    return n._v$ = L1(t, r, n._v$), a !== n._v$2 && d1(t, n._v$2 = a), n;
  }, {
    _v$: void 0,
    _v$2: void 0
  }), t;
...
q(["click"]);
const Mr = /* @__PURE__ */ g('<svg viewBox="0 0 1024 1024" class="icon"><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z"></path></svg>'), Sr = /* @__PURE__ */ g('<svg viewBox="0 0 1024 1024" class="icon"><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z"></path></svg>'), Tr = /* @__PURE__ */ g("<div></div>"), Ir = /* @__PURE__ */ g('<span class="label"></span>'), Nr = () => Mr.cloneNode(!0), Dr = () => Sr.cloneNode(!0), _9 = (e) => {
  ...
  return a1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a._v$ = L1(r, i, a._v$), o !== a._v$2 && d1(r, a._v$2 = o), a;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
q(["click"]);
const Pr = /* @__PURE__ */ g('<div class="klinecharts-pro-loading"><i class="circle1"></i><i class="circle2"></i><i class="circle3"></i></div>'), u5 = () => Pr.cloneNode(!0), Br = /* @__PURE__ */ g('<div class="klinecharts-pro-empty"><svg class="icon" viewBox="0 0 1024 1024"><path d="M855.6 427.2H168.5c-12.7 0-24.4 6.9-30.6 18L4.4 684.7C1.5 689.9 0 695.8 0 701.8v287.1c0 19.4 15.7 35.1 35.1 35.1H989c19.4 0 35.1-15.7 35.1-35.1V701.8c0-6-1.5-11.8-4.4-17.1L886.2 445.2c-6.2-11.1-17.9-18-30.6-18zM673.4 695.6c-16.5 0-30.8 11.5-34.3 27.7-12.7 58.5-64.8 102.3-127.2 102.3s-114.5-43.8-127.2-102.3c-3.5-16.1-17.8-27.7-34.3-27.7H119c-26.4 0-43.3-28-31.1-51.4l81.7-155.8c6.1-11.6 18-18.8 31.1-18.8h622.4c13 0 25 7.2 31.1 18.8l81.7 155.8c12.2 23.4-4.7 51.4-31.1 51.4H673.4zM819.9 209.5c-1-1.8-2.1-3.7-3.2-5.5-9.8-16.6-31.1-22.2-47.8-12.6L648.5 261c-17 9.8-22.7 31.6-12.6 48.4 0.9 1.4 1.7 2.9 2.5 4.4 9.5 17 31.2 22.8 48 13L807 257.3c16.7-9.7 22.4-31 12.9-47.8zM375.4 261.1L255 191.6c-16.7-9.6-38-4-47.8 12.6-1.1 1.8-2.1 3.6-3.2 5.5-9.5 16.8-3.8 38.1 12.9 47.8L337.3 327c16.9 9.7 38.6 4 48-13.1 0.8-1.5 1.7-2.9 2.5-4.4 10.2-16.8 4.5-38.6-12.4-48.4zM512 239.3h2.5c19.5 0.3 35.5-15.5 35.5-35.1v-139c0-19.3-15.6-34.9-34.8-35.1h-6.4C489.6 30.3 474 46 474 65.2v139c0 19.5 15.9 35.4 35.5 35.1h2.5z"></path></svg></div>'), Or = () => Br.cloneNode(!0), Er = /* @__PURE__ */ g("<ul></ul>"), Fr = /* @__PURE__ */ g("<li></li>"), r0 = (e) => (() => {
  ...
  return m(t, y(U, {
    ...
    get children() {
      ...
      return (n = e.dataSource) == null ? void 0 : n.map((r) => {
        var a;
        return ((a = e.renderItem) == null ? void 0 : a.call(e, r)) ?? Fr.cloneNode(!0);
      });
    }
  }), null), Z((n) => {
...
})(), Kr = /* @__PURE__ */ g('<div class="klinecharts-pro-modal"><div class="inner"><div class="title-container"><svg class="close-icon" viewBox="0 0 1024 1024"><path d="M934.184927 199.723787 622.457206 511.452531l311.727721 311.703161c14.334473 14.229073 23.069415 33.951253 23.069415 55.743582 0 43.430138-35.178197 78.660524-78.735226 78.660524-21.664416 0-41.361013-8.865925-55.642275-23.069415L511.149121 622.838388 199.420377 934.490384c-14.204513 14.20349-33.901111 23.069415-55.642275 23.069415-43.482327 0-78.737272-35.230386-78.737272-78.660524 0-21.792329 8.864902-41.513486 23.094998-55.743582l311.677579-311.703161L88.135828 199.723787c-14.230096-14.255679-23.094998-33.92567-23.094998-55.642275 0-43.430138 35.254945-78.762855 78.737272-78.762855 21.741163 0 41.437761 8.813736 55.642275 23.069415l311.727721 311.727721L822.876842 88.389096c14.281261-14.255679 33.977859-23.069415 55.642275-23.069415 43.557028 0 78.735226 35.332716 78.735226 78.762855C957.254342 165.798117 948.5194 185.468109 934.184927 199.723787"></path></svg></div><div class="content-container"></div></div></div>'), jr = /* @__PURE__ */ g('<div class="button-container"></div>'), T1 = (e) => (() => {
  const t = Kr.cloneNode(!0), n = t.firstChild, r = n.firstChild, a = r.firstChild, i = r.nextSibling;
  return m(r, () => e.title, a), l1(a, "click", e.onClose, !0), m(i, () => e.children), m(n, (() => {
    ...
    return () => o() && (() => {
      ...
      return m(s, () => e.buttons.map((c) => y(wr, E9(c, {
        get children() {
          return c.children;
        }
      })))), s;
...
q(["click"]);
const Zr = /* @__PURE__ */ g('<div tabindex="0"><div class="selector-container"><span class="value"></span><i class="arrow"></i></div></div>'), Qr = /* @__PURE__ */ g('<div class="drop-down-container"><ul></ul></div>'), Rr = /* @__PURE__ */ g("<li></li>"), C5 = (e) => {
  const [t, n] = $(!1);
  return (() => {
    const r = Zr.cloneNode(!0), a = r.firstChild, i = a.firstChild;
    return r.addEventListener("blur", (o) => {
      ...
      return () => o() && (() => {
        const s = Qr.cloneNode(!0), c = s.firstChild;
        return m(c, () => e.dataSource.map((C) => {
          const d = C[e.valueKey ?? "text"] ?? C;
          return (() => {
            const p = Rr.cloneNode(!0);
            return p.$$click = (L) => {
              var w;
      ...
      return o._v$ = L1(r, s, o._v$), c !== o._v$2 && d1(r, o._v$2 = c), o;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), r;
...
q(["click"]);
const zr = /* @__PURE__ */ g('<span class="prefix"></span>'), Ur = /* @__PURE__ */ g('<span class="suffix"></span>'), Yr = /* @__PURE__ */ g('<div><input class="value"></div>'), f5 = (e) => {
  const t = E9({
  ...
  const [r, a] = $("normal");
  return (() => {
    const i = Yr.cloneNode(!0), o = i.firstChild;
    return i.$$click = () => {
      n == null || n.focus();
    }, m(i, y(U, {
      get when() {
      ...
      return s._v$ = L1(i, c, s._v$), C !== s._v$2 && d1(i, s._v$2 = C), u !== s._v$3 && G(i, "data-status", s._v$3 = u), d !== s._v$4 && G(o, "placeholder", s._v$4 = d), s;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0,
...
q(["click"]);
const Vr = /* @__PURE__ */ g('<div><i class="thumb"></i></div>'), Hr = (e) => (() => {
...
q(["click"]);
const Gr = "指标", Xr = "主图指标", Jr = "副图指标", Wr = "设置", qr = "时区", ea = "截屏", ta = "全屏", na = "退出全屏", ra = "保存", aa = "确定", ia = "取消", sa = "MA(移动平均线)", oa = "EMA(指数平滑移动平均线)", ca = "SMA", la = "BOLL(布林线)", ua = "BBI(多空指数)", Ca = "SAR(停损点指向指标)", fa = "VOL(成交量)", ga = "MACD(指数平滑异同移动平均线)", ha = "KDJ(随机指标)", da = "RSI(相对强弱指标)", ya = "BIAS(乖离率)", ma = "BRAR(情绪指标)", pa = "CCI(顺势指标)", va = "DMI(动向指标)", _a = "CR(能量指标)", La = "PSY(心理线)", $a = "DMA(平行线差指标)", ba = "TRIX(三重指数平滑平均线)", xa = "OBV(能量潮指标)", ka = "VR(成交量变异率)", Aa = "WR(威廉指标)", wa = "MTM(动量指标)", Ma = "EMV(简易波动指标)", Sa = "ROC(变动率指标)", Ta = "PVT(价量趋势指标)", Ia = "AO(动量震荡指标)", Na = "世界统一时间", Da = "(UTC-10) 檀香山", Pa = "(UTC-8) 朱诺", Ba = "(UTC-7) 洛杉矶", Oa = "(UTC-5) 芝加哥", Ea = "(UTC-4) 多伦多", Fa = "(UTC-3) 圣保罗", Ka = "(UTC+1) 伦敦", ja = "(UTC+2) 柏林", Za = "(UTC+3) 巴林", Qa = "(UTC+4) 迪拜", Ra = "(UTC+5) 阿什哈巴德", za = "(UTC+6) 阿拉木图", Ua = "(UTC+7) 曼谷", Ya = "(UTC+8) 上海", Va = "(UTC+9) 东京", Ha = "(UTC+10) 悉尼", Ga = "(UTC+12) 诺福克岛", Xa = "水平直线", Ja = "水平射线", Wa = "水平线段", qa = "垂直直线", ei = "垂直射线", ti = "垂直线段", ni = "直线", ri = "射线", ai = "线段", ii = "箭头", si = "价格线", oi = "价格通道线", ci = "平行直线", li = "斐波那契回调直线", ui = "斐波那契回调线段", Ci = "斐波那契圆环", fi = "斐波那契螺旋", gi = "斐波那契速度阻力扇", hi = "斐波那契趋势扩展", di = "江恩箱", yi = "矩形", mi = "平行四边形", pi = "圆", vi = "三角形", _i = "三浪", Li = "五浪", $i = "八浪", bi = "任意浪", xi = "ABCD形态", ki = "XABCD形态", Ai = "弱磁模式", wi = "强磁模式", Mi = "商品搜索", Si = "商品代码", Ti = "参数1", Ii = "参数2", Ni = "参数3", Di = "参数4", Pi = "参数5", Bi = "周期", Oi = "标准差", Ei = "蜡烛图类型", Fi = "全实心", Ki = "全空心", ji = "涨空心", Zi = "跌空心", Qi = "OHLC", Ri = "面积图", zi = "最新价显示", Ui = "最高价显示", Yi = "最低价显示", Vi = "指标最新值显示", Hi = "价格轴类型", Gi = "线性轴", Xi = "百分比轴", Ji = "对数轴", Wi = "倒置坐标", qi = "网格线显示", es = "恢复默认", ts = {
  indicator: Gr,
  main_indicator: Xr,
  sub_indicator: Jr,
  setting: Wr,
  ...
  sydney: Ha,
  norfolk: Ga,
  horizontal_straight_line: Xa,
  horizontal_ray_line: Ja,
  horizontal_segment: Wa,
  vertical_straight_line: qa,
  vertical_ray_line: ei,
  vertical_segment: ti,
  straight_line: ni,
  ray_line: ri,
  segment: ai,
  arrow: ii,
  price_line: si,
  price_channel_line: oi,
  parallel_straight_line: ci,
  fibonacci_line: li,
  fibonacci_segment: ui,
  fibonacci_circle: Ci,
  fibonacci_spiral: fi,
  fibonacci_speed_resistance_fan: gi,
  fibonacci_extension: hi,
  gann_box: di,
  rect: yi,
  parallelogram: mi,
  circle: pi,
  ...
  params_5: Pi,
  period: Bi,
  standard_deviation: Oi,
  candle_type: Ei,
  candle_solid: Fi,
  candle_stroke: Ki,
  candle_up_stroke: ji,
  candle_down_stroke: Zi,
  ohlc: Qi,
  area: Ri,
  last_price_show: zi,
  high_price_show: Ui,
  ...
  grid_show: qi,
  restore_default: es
}, ns = "Indicator", rs = "Main Indicator", as = "Sub Indicator", is = "Setting", ss = "Timezone", os = "Screenshot", cs = "Full Screen", ls = "Exit", us = "Save", Cs = "Confirm", fs = "Cancel", gs = "MA(Moving Average)", hs = "EMA(Exponential Moving Average)", ds = "SMA", ys = "BOLL(Bolinger Bands)", ms = "BBI(Bull And Bearlndex)", ps = "SAR(Stop and Reverse)", vs = "VOL(Volume)", _s = "MACD(Moving Average Convergence / Divergence)", Ls = "KDJ(KDJ Index)", $s = "RSI(Relative Strength Index)", bs = "BIAS(Bias Ratio)", xs = "BRAR(情绪指标)", ks = "CCI(Commodity Channel Index)", As = "DMI(Directional Movement Index)", ws = "CR(能量指标)", Ms = "PSY(Psychological Line)", Ss = "DMA(Different of Moving Average)", Ts = "TRIX(Triple Exponentially Smoothed Moving Average)", Is = "OBV(On Balance Volume)", Ns = "VR(Volatility Volume Ratio)", Ds = "WR(Williams %R)", Ps = "MTM(Momentum Index)", Bs = "EMV(Ease of Movement Value)", Os = "ROC(Price Rate of Change)", Es = "PVT(Price and Volume Trend)", Fs = "AO(Awesome Oscillator)", Ks = "UTC", js = "(UTC-10) Honolulu", Zs = "(UTC-8) Juneau", Qs = "(UTC-7) Los Angeles", Rs = "(UTC-5) Chicago", zs = "(UTC-4) Toronto", Us = "(UTC-3) Sao Paulo", Ys = "(UTC+1) London", Vs = "(UTC+2) Berlin", Hs = "(UTC+3) Bahrain", Gs = "(UTC+4) Dubai", Xs = "(UTC+5) Ashkhabad", Js = "(UTC+6) Almaty", Ws = "(UTC+7) Bangkok", qs = "(UTC+8) Shanghai", eo = "(UTC+9) Tokyo", to = "(UTC+10) Sydney", no = "(UTC+12) Norfolk", ro = "Horizontal Line", ao = "Horizontal Ray", io = "Horizontal Segment", so = "Vertical Line", oo = "Vertical Ray", co = "Vertical Segment", lo = "Trend Line", uo = "Ray", Co = "Segment", fo = "Arrow", go = "Price Line", ho = "Price Channel Line", yo = "Parallel Line", mo = "Fibonacci Line", po = "Fibonacci Segment", vo = "Fibonacci Circle", _o = "Fibonacci Spiral", Lo = "Fibonacci Sector", $o = "Fibonacci Extension", bo = "Gann Box", xo = "Rect", ko = "Parallelogram", Ao = "Circle", wo = "Triangle", Mo = "Three Waves", So = "Five Waves", To = "Eight Waves", Io = "Any Waves", No = "ABCD Pattern", Do = "XABCD Pattern", Po = "Weak Magnet", Bo = "Strong Magnet", Oo = "Symbol Search", Eo = "Symbol Code", Fo = "Parameter 1", Ko = "Parameter 2", jo = "Parameter 3", Zo = "Parameter 4", Qo = "Parameter 5", Ro = "Period", zo = "Standard Deviation", Uo = "Candle Type", Yo = "Candle Solid", Vo = "Candle Stroke", Ho = "Candle Up Stroke", Go = "Candle Down Stroke", Xo = "OHLC", Jo = "Area", Wo = "Show Last Price", qo = "Show Highest Price", ec = "Show Lowest Price", tc = "Show indicator's last value", nc = "Price Axis Type", rc = "Normal", ac = "Percentage", ic = "Log", sc = "Reverse Coordinate", oc = "Show Grids", cc = "Restore Defaults", lc = {
  indicator: ns,
  main_indicator: rs,
  sub_indicator: as,
  setting: is,
  ...
  horizontal_ray_line: ao,
  horizontal_segment: io,
  vertical_straight_line: so,
  vertical_ray_line: oo,
  vertical_segment: co,
  straight_line: lo,
  ray_line: uo,
  segment: Co,
  arrow: fo,
  price_line: go,
  price_channel_line: ho,
  parallel_straight_line: yo,
  fibonacci_line: mo,
  fibonacci_segment: po,
  fibonacci_circle: vo,
  fibonacci_spiral: _o,
  fibonacci_speed_resistance_fan: Lo,
...
const l = (e, t) => {
  ...
  return T9(() => {
    ...
    const i = fc.cloneNode(!0), o = i.firstChild, s = o.firstChild, c = o.nextSibling, C = c.firstChild, u = C.nextSibling, d = c.nextSibling, p = d.firstChild, L = p.nextSibling, w = d.nextSibling, B = w.firstChild, F = B.nextSibling, M = w.nextSibling, Q = M.firstChild, S = Q.nextSibling, A = M.nextSibling;
    return w0((b) => {
      t = b;
      ...
      get children() {
        const b = Cc.cloneNode(!0), O = b.firstChild;
      ...
      return O.$$click = () => {
        e.onPeriodChange(b);
      }, m(O, () => b.text), Z(() => d1(O, `item period ${b.text === e.period.text ? "selected" : ""}`)), O;
...
q(["click"]);
const yc = /* @__PURE__ */ g('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), mc = () => yc.cloneNode(!0), pc = /* @__PURE__ */ g('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,11L11.08535,11C11.29127,10.417404,11.84689,10,12.5,10C13.15311,10,13.70873,10.417404,13.91465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L13.91465,12C13.70873,12.5826,13.15311,13,12.5,13C11.84689,13,11.29127,12.5826,11.08535,12L6.91465,12C6.70873,12.5826,6.15311,13,5.5,13C4.671573,13,4,12.32843,4,11.5C4,10.671573,4.671573,10,5.5,10C6.15311,10,6.70873,10.417404,6.91465,11Z" stroke-opacity="0" stroke="none"></path></svg>'), vc = () => pc.cloneNode(!0), _c = /* @__PURE__ */ g('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M6.91465,12.5C6.70873,13.0826,6.15311,13.5,5.5,13.5C4.671573,13.5,4,12.82843,4,12C4,11.171573,4.671573,10.5,5.5,10.5C6.15311,10.5,6.70873,10.917404,6.91465,11.5L16.0853,11.5C16.2913,10.917404,16.846899999999998,10.5,17.5,10.5C18.328400000000002,10.5,19,11.171573,19,12C19,12.82843,18.328400000000002,13.5,17.5,13.5C16.846899999999998,13.5,16.2913,13.0826,16.0853,12.5L6.91465,12.5Z" stroke-opacity="0" stroke="none"></path></svg>'), Lc = () => _c.cloneNode(!0), $c = /* @__PURE__ */ g('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M11,12.41465L11,18.5C11,18.7761,11.22386,19,11.5,19C11.77614,19,12,18.7761,12,18.5L12,12.41465C12.5826,12.20873,13,11.65311,13,11C13,10.34689,12.5826,9.79127,12,9.58535L12,3.5C12,3.223857,11.77614,3,11.5,3C11.22386,3,11,3.223857,11,3.5L11,9.58535C10.417404,9.79127,10,10.34689,10,11C10,11.65311,10.417404,12.20873,11,12.41465Z" stroke-opacity="0" stroke="none"></path></svg>'), bc = () => $c.cloneNode(!0), xc = /* @__PURE__ */ g('<svg class="icon-overlay" viewBox="0 0 22 22"><path d="M11.66558837890625,19C10.83716137890625,19,10.16558837890625,18.328400000000002,10.16558837890625,17.5C10.16558837890625,16.846899999999998,10.58298437890625,16.2913,11.16557337890625,16.0854L11.16557337890625,11.91464C10.58298437890625,11.70872,10.16558837890625,11.1531,10.16558837890625,10.5C10.16558837890625,9.8469,10.58298437890625,9.29128,11.16557337890625,9.08536L11.16557337890625,4.5C11.16557337890625,4.223857,11.38942837890625,4,11.66556837890625,4C11.94171837890625,4,12.16556837890625,4.223857,12.16556837890625,4.5L12.16556837890625,9.08535C12.74817837890
  horizontalRayLine: vc,
  horizontalSegment: Lc,
  verticalStraightLine: bc,
  verticalRayLine: kc,
  verticalSegment: wc,
  straightLine: Sc,
  rayLine: Ic,
  ...
  priceLine: Ec,
  priceChannelLine: Kc,
  parallelStraightLine: Zc,
  fibonacciLine: Rc,
  fibonacciSegment: Uc,
  fibonacciCircle: Vc,
  fibonacciSpiral: Gc,
  fibonacciSpeedResistanceFan: Jc,
  fibonacciExtension: qc,
  gannBox: tl,
  circle: rl,
  triangle: il,
  rect: ol,
...
const J = (e) => Ol[e.name](e.class), Rl = /* @__PURE__ */ g('<div class="klinecharts-pro-drawing-bar"><span class="split-line"></span><div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div><div class="item"><span style="width:32px;height:32px"></span></div><div class="item"><span style="width:32px;height:32px"></span></div><span class="split-line"></span><div class="item"><span style="width:32px;height:32px"></span></div></div>'), zl = /* @__PURE__ */ g('<div class="item" tabindex="0"><span style="width:32px;height:32px"></span><div class="icon-arrow"><svg viewBox="0 0 4 6"><path d="M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z" stroke="none" stroke-opacity="0"></path></svg></div></div>'), L9 = /* @__PURE__ */ g('<li><span style="padding-left:8px"></span></li>'), $9 = "drawing_tools", Ul = (e) => {
  ...
  return (() => {
    const H = Rl.cloneNode(!0), t1 = H.firstChild, x = t1.nextSibling, D = x.firstChild, j = D.nextSibling, n1 = j.firstChild, I1 = x.nextSibling, N1 = I1.firstChild, C1 = I1.nextSibling, E1 = C1.firstChild, F1 = C1.nextSibling, K1 = F1.nextSibling, j1 = K1.firstChild;
    return m(H, () => b().map((k) => (() => {
      const z = zl.cloneNode(!0), W = z.firstChild, c1 = W.nextSibling, Z1 = c1.firstChild;
      return z.addEventListener("blur", () => {
        ...
        return () => D1() && y(r0, {
          ...
          get children() {
            return k.list.map((h) => (() => {
              const f = L9.cloneNode(!0), v = f.firstChild;
              return f.$$click = () => {
                k.setter(h.key), e.onDrawingItemClick({
                  name: h.key,
                  lock: B(),
                  mode: L()
                }), A("");
      ...
      })(), null), Z(() => G(Z1, "class", k.key === S() ? "rotate" : "")), z;
      ...
      return () => k() && y(r0, {
        ...
        get children() {
          return O().map((z) => (() => {
            const W = L9.cloneNode(!0), c1 = W.firstChild;
            return W.$$click = () => {
...
q(["click"]);
const b9 = /* @__PURE__ */ g('<li class="title"></li>'), x9 = /* @__PURE__ */ g('<li class="row"></li>'), Yl = (e) => y(T1, {
  get title() {
...
const Hl = (e) => {
  const [t, n] = $(e.timezone), r = K(() => Vl(e.locale));
  return y(T1, {
    get title() {
...
const Gl = /* @__PURE__ */ g('<div class="klinecharts-pro-setting-modal-content"></div>'), Xl = /* @__PURE__ */ g("<span></span>"), Jl = (e) => {
  const [t, n] = $(e.currentStyles), [r, a] = $(A9(e.locale));
  a1(() => {
    a(A9(e.locale));
  });
  const i = (o, s) => {
...
}, Wl = /* @__PURE__ */ g('<img style="width:500px;margin-top: 20px">'), ql = (e) => y(T1, {
  get title() {
...
}, tu = /* @__PURE__ */ g('<div class="klinecharts-pro-indicator-setting-modal-content"></div>'), nu = /* @__PURE__ */ g("<span></span>"), ru = (e) => {
  const [t, n] = $(P.clone(e.params.calcParams)), r = (a) => eu[a];
  return y(T1, {
    get title() {
    ...
    get children() {
      const a = tu.cloneNode(!0);
      return m(a, () => r(e.params.indicatorName).map((i, o) => [(() => {
        const s = nu.cloneNode(!0);
...
}, au = /* @__PURE__ */ g('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z"></path></svg>'), iu = /* @__PURE__ */ g('<img alt="symbol">'), su = /* @__PURE__ */ g("<li><div><span></span></div></li>"), ou = (e) => {
  const [t, n] = $(""), [r] = Z5(t, e.datafeed.searchSymbols.bind(e.datafeed));
  return y(T1, {
    get title() {
    ...
    get children() {
      return [y(f5, {
        ...
        renderItem: (a) => (() => {
          const i = su.cloneNode(!0), o = i.firstChild, s = o.firstChild;
          return i.$$click = () => {
...
q(["click"]);
const cu = /* @__PURE__ */ g('<i class="icon-close klinecharts-pro-load-icon"></i>'), lu = /* @__PURE__ */ g('<div class="klinecharts-pro-content"><div class="klinecharts-pro-widget"></div></div>');
function Y1(e, t, n, r) {
  return t === "VOL" && (r = {
    gap: {
      bottom: 2
...
const uu = (e) => {
  ...
  const [i, o] = $(e.theme), [s, c] = $(e.styles), [C, u] = $(e.locale), [d, p] = $(e.symbol), [L, w] = $(e.period), [B, F] = $(!1), [M, Q] = $([...e.mainIndicators]), [S, A] = $({}), [b, O] = $(!1), [H, t1] = $({
    key: e.timezone,
    text: k9(e.timezone, e.locale)
  }), [x, D] = $(!1), [j, n1] = $(), [I1, N1] = $(""), [C1, E1] = $(e.drawingBarVisible), [F1, K1] = $(!1), [j1, k] = $(!1), [z, W] = $({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  return T9(() => {
    if (window.addEventListener("resize", Z1), n = y5(t, {
      customApi: {
        formatDate: (f, v, _, E) => {
          switch (L().timespan) {
            case "minute":
              return E === Q1.XAxis ? P.formatDate(f, v, "HH:mm") : P.formatDate(f, v, "YYYY-MM-DD HH:mm");
            case "hour":
              return E === Q1.XAxis ? P.formatDate(f, v, "MM-DD HH:mm") : P.formatDate(f, v, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return P.formatDate(f, v, "YYYY-MM-DD");
            case "month":
              return E === Q1.XAxis ? P.formatDate(f, v, "YYYY-MM") : P.formatDate(f, v, "YYYY-MM-DD");
            case "year":
              return E === Q1.XAxis ? P.formatDate(f, v, "YYYY") : P.formatDate(f, v, "YYYY-MM-DD");
          }
          return P.formatDate(f, v, "YYYY-MM-DD HH:mm");
        }
      }
    }), c1 = n, n && e.onChartReady && e.onChartReady(n), n) {
      const f = n.getDom("candle_pane", j0.Main);
      if (f) {
      ...
      const v = n.getDom("candle_pane", j0.YAxis);
    ...
    e.subIndicators.forEach((f) => {
      ...
      a = !0, (async () => {
        const _ = L(), [E] = D1(_, f, 1), [r1] = D1(_, E, 500), X = await e.datafeed.getHistoryKLineData(d(), _, r1, E);
        n == null || n.applyMoreData(X, X.length > 0), a = !1;
      })();
    }), n == null || n.subscribeAction(m5.OnTooltipIconClick, (f) => {
      if (f.indicatorName)
        switch (f.iconId) {
          case "visible": {
    ...
    window.removeEventListener("resize", Z1), p5(t);
  }), a1(() => {
    const h = d();
    ...
    s() && (n == null || n.setStyles(s()), n1(kr(n.getStyles())));
  }), [cu.cloneNode(!0), y(U, {
    get when() {
      return F1();
    },
    ...
    onMenuClick: async () => {
      try {
        await Q5(() => E1(!C1())), n == null || n.resize();
      } catch {
      }
    },
    onSymbolClick: () => {
    ...
    const h = lu.cloneNode(!0), f = h.firstChild;
    m(h, y(U, {
      get when() {
        return j1();
      },
