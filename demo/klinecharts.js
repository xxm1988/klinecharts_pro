...
var ID = /** @class */ (function () {
    ...
    ID.prototype.next = function (prefix) {
        ...
        return "".concat(prefix !== null && prefix !== void 0 ? prefix : '').concat(timestamp, "_").concat(this._baseId);
    };
    return ID;
}());
var id = new ID();
...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 9.1.1', 'border-radius:2px;border:dashed 1px #1677FF;padding:26px 20px;margin:16px 0;font-size:14px;color:#1677FF', '', '', '');
}
...
var TimeScaleStore = /** @class */ (function () {
    ...
    TimeScaleStore.prototype.adjustVisibleRange = function () {
        ...
        this._visibleRange = { from: from, to: to };
        this._chartStore.getActionStore().execute(exports.ActionType.OnVisibleRangeChange, { from: from, to: to });
...
function eachFigures(kLineDataList, indicator, dataIndex, defaultStyles, eachFigureCallback) {
    ...
    figures.forEach(function (figure) {
        ...
        if (isValid(defaultFigureStyles)) {
            ...
            var figureStyles = (_b = (_a = figure.styles) === null || _a === void 0 ? void 0 : _a.call(figure, cbData, indicator, defaultStyles)) !== null && _b !== void 0 ? _b : { style: defaultFigureStyle, color: defaultFigureColor };
...
var easeOfMovementValue = {
    ...
    calc: function (dataList, indicator) {
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            var high = kLineData.high;
            var low = kLineData.low;
            var turnover = (_b = kLineData.turnover) !== null && _b !== void 0 ? _b : 0;
            var halfHl = (high + low) / 2;
            var prevHalfHl = (prevKLineData.high + prevKLineData.low) / 2;
            var hl = high - low;
            var em = 0;
            if (turnover !== 0) {
...
var onBalanceVolume = {
    ...
    calc: function (dataList, indicator) {
        ...
        dataList.forEach(function (kLineData, i) {
            var _a, _b, _c, _d;
            var preKLineData = (_a = dataList[i - 1]) !== null && _a !== void 0 ? _a : kLineData;
...
var fibonacciLine = {
    ...
    createPointFigures: function (_a) {
        var coordinates = _a.coordinates, bounding = _a.bounding, overlay = _a.overlay, precision = _a.precision;
        ...
        if (coordinates.length > 0) {
            ...
            if (coordinates.length > 1 && points[0].value !== undefined && points[1].value !== undefined) {
                ...
                percents.forEach(function (percent) {
                    ...
                    var value = (((_a = points[1].value) !== null && _a !== void 0 ? _a : 0) + valueDif_1 * percent).toFixed(precision.price);
...
var OverlayStore = /** @class */ (function () {
    ...
    OverlayStore.prototype._overrideInstance = function (instance, overlay) {
        var id = overlay.id, groupId = overlay.groupId, points = overlay.points, styles = overlay.styles, lock = overlay.lock, visible = overlay.visible, mode = overlay.mode, extendData = overlay.extendData, onDrawStart = overlay.onDrawStart, onDrawing = overlay.onDrawing, onDrawEnd = overlay.onDrawEnd, onClick = overlay.onClick, onRightClick = overlay.onRightClick, onPressedMoveStart = overlay.onPressedMoveStart, onPressedMoving = overlay.onPressedMoving, onPressedMoveEnd = overlay.onPressedMoveEnd, onMouseEnter = overlay.onMouseEnter, onMouseLeave = overlay.onMouseLeave, onRemoved = overlay.onRemoved, onSelected = overlay.onSelected, onDeselected = overlay.onDeselected;
        var updateFlag = false;
        if (id !== undefined) {
            instance.setId(id);
        }
    ...
    OverlayStore.prototype.addInstance = function (overlay, paneId, appointPaneFlag) {
        var _a, _b, _c, _d;
        ...
        if (this.getInstanceById(id) === null) {
            ...
            if (instance.isDrawing()) {
                this._progressInstanceInfo = { paneId: paneId, instance: instance, appointPaneFlag: appointPaneFlag };
            }
            else {
    ...
    OverlayStore.prototype.setHoverInstanceInfo = function (info, event) {
        var _a, _b, _c, _d, _e;
        var _f = this._hoverInstanceInfo, instance = _f.instance, figureType = _f.figureType, figureIndex = _f.figureIndex;
        if ((instance === null || instance === void 0 ? void 0 : instance.id) !== ((_a = info.instance) === null || _a === void 0 ? void 0 : _a.id) ||
            ...
            if ((instance === null || instance === void 0 ? void 0 : instance.id) !== ((_b = info.instance) === null || _b === void 0 ? void 0 : _b.id)) {
                (_c = instance === null || instance === void 0 ? void 0 : instance.onMouseLeave) === null || _c === void 0 ? void 0 : _c.call(instance, __assign({ overlay: instance }, event));
                (_e = (_d = info.instance) === null || _d === void 0 ? void 0 : _d.onMouseEnter) === null || _e === void 0 ? void 0 : _e.call(_d, __assign({ overlay: info.instance }, event));
            }
        }
    };
    ...
    OverlayStore.prototype.setClickInstanceInfo = function (info, event) {
        ...
        var _k = this._clickInstanceInfo, paneId = _k.paneId, instance = _k.instance, figureType = _k.figureType, figureIndex = _k.figureIndex;
        if (!((_b = (_a = info.instance) === null || _a === void 0 ? void 0 : _a.isDrawing()) !== null && _b !== void 0 ? _b : false)) {
            (_d = (_c = info.instance) === null || _c === void 0 ? void 0 : _c.onClick) === null || _d === void 0 ? void 0 : _d.call(_c, __assign({ overlay: info.instance }, event));
        }
        if ((instance === null || instance === void 0 ? void 0 : instance.id) !== ((_e = info.instance) === null || _e === void 0 ? void 0 : _e.id) || figureType !== info.figureType || figureIndex !== info.figureIndex) {
            ...
            if ((instance === null || instance === void 0 ? void 0 : instance.id) !== ((_f = info.instance) === null || _f === void 0 ? void 0 : _f.id)) {
                (_g = instance === null || instance === void 0 ? void 0 : instance.onDeselected) === null || _g === void 0 ? void 0 : _g.call(instance, __assign({ overlay: instance }, event));
                (_j = (_h = info.instance) === null || _h === void 0 ? void 0 : _h.onSelected) === null || _j === void 0 ? void 0 : _j.call(_h, __assign({ overlay: info.instance }, event));
            ...
            if (indicator.visible) {
                ...
                if (!isCover) {
                    ...
                    _this.eachChildren(function (data, barSpace) {
                        ...
                        var indicatorData = (_a = result_1[dataIndex]) !== null && _a !== void 0 ? _a : {};
                        eachFigures(dataList, indicator, dataIndex, defaultStyles, function (figure, figureStyles, defaultFigureStyles, count) {
                            var _a, _b, _c;
                            var value = indicatorData[figure.key];
                            var valueY = yAxis.convertToPixel(value);
                            switch (figure.type) {
                                case 'circle': {
                                    if (isValid(value)) {
                                        (_a = _this.createFigure('circle', {
                                            x: x,
                                            y: valueY,
                                            r: halfGapBar
                                        }, {
                                ...
                                case 'line': {
                                    var innerFigureStyle = null;
                                    if (isValid(value)) {
                                        innerFigureStyle = figureStyles;
                                        var coordinate = { x: x, y: valueY };
                                        var prevFigureStyles = lineFigureStyles_1[count];
                                        if (!isValid(lineCoordinates_1[count])) {
                                            lineCoordinates_1[count] = [];
                                        }
                                        lineCoordinates_1[count].push(coordinate);
                                        if (isValid(prevFigureStyles)) {
                                            if ((prevFigureStyles === null || prevFigureStyles === void 0 ? void 0 : prevFigureStyles.color) !== figureStyles.color) {
                                                lines_1.push({
                                                    name: 'line',
                                                    attrs: { coordinates: lineCoordinates_1[count] },
                                                    styles: {
                                                        style: figureStyles.style,
                                                        color: figureStyles.color,
                                                ...
                                                lineCoordinates_1[count] = [coordinate];
                                            }
                                            else {
                                    ...
                                    lineFigureStyles_1[count] = innerFigureStyle;
                                    break;
                                }
                            }
                        });
                    });
                    lines_1.forEach(function (_a) {
                        var _b;
                        var attrs = _a.attrs, styles = _a.styles;
                        (_b = _this.createFigure('line', attrs, styles)) === null || _b === void 0 ? void 0 : _b.draw(ctx);
                    });
                }
            }
        });
...
var IndicatorTooltipView = /** @class */ (function (_super) {
    ...
    IndicatorTooltipView.prototype.drawImp = function (ctx) {
        ...
        if (crosshair.kLineData !== undefined) {
            ...
            var defaultStyles = chartStore.getStyles().indicator;
            this.drawIndicatorTooltip(ctx, pane.getId(), chartStore.getDataList(), crosshair, activeIconInfo, indicators, customApi, bounding, defaultStyles);
        }
    };
    IndicatorTooltipView.prototype.drawIndicatorTooltip = function (ctx, paneId, dataList, crosshair, activeTooltipIconInfo, indicators, customApi, bounding, styles, top) {
        var _this = this;
        ...
        if (this.isDrawTooltip(crosshair, tooltipStyles)) {
            ...
            indicators.forEach(function (indicator) {
                var _a = _this.getIndicatorTooltipData(dataList, crosshair, indicator, customApi, styles), name = _a.name, calcParamsText = _a.calcParamsText, values = _a.values, icons = _a.icons;
    ...
    IndicatorTooltipView.prototype.getIndicatorTooltipData = function (dataList, crosshair, indicator, customApi, styles) {
        var _a, _b, _c;
        var tooltipStyles = styles.tooltip;
        ...
        if (indicator.visible) {
            ...
            eachFigures(dataList, indicator, dataIndex, styles, function (figure, figureStyles) {
                if (figure.title !== undefined) {
                    ...
                    values.push({ title: { text: figure.title, color: color }, value: { text: value !== null && value !== void 0 ? value : tooltipStyles.defaultValue, color: color } });
                }
            });
...
var OverlayView = /** @class */ (function (_super) {
        ...
        this.registerEvent('mouseMoveEvent', function (event) {
            ...
            if (progressInstanceInfo !== null) {
                ...
                if (overlay.isDrawing() && progressInstancePaneId === paneId) {
                    ...
                    (_a = overlay.onDrawing) === null || _a === void 0 ? void 0 : _a.call(overlay, __assign({ overlay: overlay }, event));
                }
                return _this._figureMouseMoveEvent(progressInstanceInfo.instance, 1 /* EventOverlayInfoFigureType.Point */, progressInstanceInfo.instance.points.length - 1, 0)(event);
            }
            overlayStore.setHoverInstanceInfo({
                paneId: paneId,
                instance: null, figureType: 0 /* EventOverlayInfoFigureType.None */, figureIndex: -1, attrsIndex: -1
            }, event);
            return false;
            ...
            if (progressInstanceInfo !== null) {
                ...
                if (overlay.isDrawing() && progressInstancePaneId === paneId) {
                    ...
                    if (!overlay.isDrawing()) {
                        ...
                        (_b = overlay.onDrawEnd) === null || _b === void 0 ? void 0 : _b.call(overlay, __assign({ overlay: overlay }, event));
                    }
                }
                return _this._figureMouseClickEvent(overlay, 1 /* EventOverlayInfoFigureType.Point */, overlay.points.length - 1, 0)(event);
            }
            ...
            if (progressInstanceInfo !== null) {
                ...
                if (overlay.isDrawing() && progressInstancePaneId === paneId) {
                    ...
                    if (!overlay.isDrawing()) {
                        overlayStore.progressInstanceComplete();
                        (_a = overlay.onDrawEnd) === null || _a === void 0 ? void 0 : _a.call(overlay, __assign({ overlay: overlay }, event));
                    }
                }
                return true;
            }
            ...
            if (progressInstanceInfo !== null) {
                var overlay = progressInstanceInfo.instance;
                if (overlay.isDrawing()) {
                    return _this._figureMouseRightClickEvent(overlay, 1 /* EventOverlayInfoFigureType.Point */, overlay.points.length - 1, 0)(event);
                }
            }
            return false;
        }).registerEvent('mouseUpEvent', function (event) {
            var _a;
            var instance = overlayStore.getPressedInstanceInfo().instance;
            if (instance !== null) {
                (_a = instance.onPressedMoveEnd) === null || _a === void 0 ? void 0 : _a.call(instance, __assign({ overlay: instance }, event));
            }
            ...
            var _a, _b;
            var _c = overlayStore.getPressedInstanceInfo(), instance = _c.instance, figureType = _c.figureType, figureIndex = _c.figureIndex;
            if (instance !== null) {
                if (!instance.lock) {
                    if (!((_b = (_a = instance.onPressedMoving) === null || _a === void 0 ? void 0 : _a.call(instance, __assign({ overlay: instance }, event))) !== null && _b !== void 0 ? _b : false)) {
    ...
    OverlayView.prototype._createFigureEvents = function (overlay, figureType, figureIndex, attrsIndex) {
        if (!overlay.isDrawing()) {
            return {
    ...
    OverlayView.prototype._figureMouseMoveEvent = function (overlay, figureType, figureIndex, attrsIndex) {
        var _this = this;
        return function (event) {
            var pane = _this.getWidget().getPane();
            var overlayStore = pane.getChart().getChartStore().getOverlayStore();
            overlayStore.setHoverInstanceInfo({ paneId: pane.getId(), instance: overlay, figureType: figureType, figureIndex: figureIndex, attrsIndex: attrsIndex }, event);
            return true;
        };
    };
    OverlayView.prototype._figureMouseDownEvent = function (overlay, figureType, figureIndex, attrsIndex) {
        var _this = this;
        return function (event) {
            var _a;
            var pane = _this.getWidget().getPane();
            ...
            (_a = overlay.onPressedMoveStart) === null || _a === void 0 ? void 0 : _a.call(overlay, __assign({ overlay: overlay }, event));
            overlayStore.setPressedInstanceInfo({ paneId: paneId, instance: overlay, figureType: figureType, figureIndex: figureIndex, attrsIndex: attrsIndex });
            return true;
        };
    };
    OverlayView.prototype._figureMouseClickEvent = function (overlay, figureType, figureIndex, attrsIndex) {
        var _this = this;
        return function (event) {
            var pane = _this.getWidget().getPane();
            var paneId = pane.getId();
            var overlayStore = pane.getChart().getChartStore().getOverlayStore();
            overlayStore.setClickInstanceInfo({ paneId: paneId, instance: overlay, figureType: figureType, figureIndex: figureIndex, attrsIndex: attrsIndex }, event);
            return true;
        };
    };
    OverlayView.prototype._figureMouseRightClickEvent = function (overlay, _figureType, _figureIndex, _attrsIndex) {
        var _this = this;
        return function (event) {
            var _a, _b;
            if (!((_b = (_a = overlay.onRightClick) === null || _a === void 0 ? void 0 : _a.call(overlay, __assign({ overlay: overlay }, event))) !== null && _b !== void 0 ? _b : false)) {
                var pane = _this.getWidget().getPane();
                var overlayStore = pane.getChart().getChartStore().getOverlayStore();
                ...
                if (kLineData !== null) {
                    if (value > kLineData.high) {
                        if (overlay.mode === exports.OverlayMode.WeakMagnet) {
                            ...
                            var buffValue = yAxis.convertFromPixel(highY - 8);
                            if (value < buffValue) {
                        ...
                        if (overlay.mode === exports.OverlayMode.WeakMagnet) {
                            ...
                            var buffValue = yAxis.convertFromPixel(lowY - 8);
                            if (value > buffValue) {
                                value = kLineData.low;
                            }
                        }
    ...
    OverlayView.prototype.drawImp = function (ctx) {
        ...
        overlays.forEach(function (overlay) {
            if (overlay.visible) {
                _this._drawOverlay(ctx, overlay, bounding, barSpace, precision, dateTimeFormat, customApi, defaultStyles, xAxis, yAxis, hoverInstanceInfo, clickInstanceInfo, timeScaleStore);
            }
        });
        var progressInstanceInfo = overlayStore.getProgressInstanceInfo();
        if (progressInstanceInfo !== null) {
    ...
    OverlayView.prototype._drawOverlay = function (ctx, overlay, bounding, barSpace, precision, dateTimeFormat, customApi, defaultStyles, xAxis, yAxis, hoverInstanceInfo, clickInstanceInfo, timeScaleStore) {
        var points = overlay.points;
        ...
        if (coordinates.length > 0) {
            var figures = new Array().concat(this.getFigures(overlay, coordinates, bounding, barSpace, precision, dateTimeFormat, defaultStyles, xAxis, yAxis));
    ...
    OverlayView.prototype.drawFigures = function (ctx, overlay, figures, defaultStyles) {
        ...
        figures.forEach(function (figure, figureIndex) {
            ...
            attrsArray.forEach(function (ats, attrsIndex) {
                var _a, _b;
                var evnets = !(ignoreEvent !== null && ignoreEvent !== void 0 ? ignoreEvent : false) ? _this._createFigureEvents(overlay, 2 /* EventOverlayInfoFigureType.Other */, figureIndex, attrsIndex) : undefined;
                var ss = __assign(__assign(__assign({}, defaultStyles[type]), (_a = overlay.styles) === null || _a === void 0 ? void 0 : _a[type]), styles);
                (_b = _this.createFigure(type, ats, ss, evnets)) === null || _b === void 0 ? void 0 : _b.draw(ctx);
            });
        });
    };
    ...
    OverlayView.prototype.getFigures = function (overlay, coordinates, bounding, barSpace, precision, dateTimeFormat, defaultStyles, xAxis, yAxis) {
        var _a, _b;
        return (_b = (_a = overlay.createPointFigures) === null || _a === void 0 ? void 0 : _a.call(overlay, { overlay: overlay, coordinates: coordinates, bounding: bounding, barSpace: barSpace, precision: precision, dateTimeFormat: dateTimeFormat, defaultStyles: defaultStyles, xAxis: xAxis, yAxis: yAxis })) !== null && _b !== void 0 ? _b : [];
    };
    OverlayView.prototype.drawDefaultFigures = function (ctx, overlay, coordinates, _bounding, _precision, _dateTimeFormat, _customApi, defaultStyles, _xAxis, _yAxis, hoverInstanceInfo, clickInstanceInfo) {
        var _this = this;
        var _a, _b;
        if (overlay.needDefaultPointFigure) {
            if ((((_a = hoverInstanceInfo.instance) === null || _a === void 0 ? void 0 : _a.id) === overlay.id && hoverInstanceInfo.figureType !== 0 /* EventOverlayInfoFigureType.None */) ||
                ...
                coordinates.forEach(function (_a, index) {
                    ...
                    (_c = _this.createFigure('circle', { x: x, y: y, r: radius + borderSize }, { color: borderColor }, _this._createFigureEvents(overlay, 1 /* EventOverlayInfoFigureType.Point */, index, 0))) === null || _c === void 0 ? void 0 : _c.draw(ctx);
...
var CandleAreaView = /** @class */ (function (_super) {
    ...
    CandleAreaView.prototype.drawImp = function (ctx) {
        ...
        if (areaCoordinateCount > 0) {
            ...
            var endX = lastCoordinate.x + barSpace.halfGapBar;
    ...
    CandleHighLowPriceView.prototype.drawImp = function (ctx) {
        ...
        if (priceMarkStyles.show && (highPriceMarkStyles.show || lowPriceMarkStyles.show)) {
            ...
            if (highPriceMarkStyles.show && high_1 !== Number.MIN_SAFE_INTEGER) {
                this._drawMark(ctx, formatPrecision(high_1, precision.price), { x: highX_1, y: highY }, highY < lowY ? [-2, -5] : [2, 5], highPriceMarkStyles);
            }
            if (lowPriceMarkStyles.show && low_1 !== Number.MAX_SAFE_INTEGER) {
                this._drawMark(ctx, formatPrecision(low_1, precision.price), { x: lowX_1, y: lowY }, highY < lowY ? [2, 5] : [-2, -5], lowPriceMarkStyles);
            }
        }
    };
...
var CandleTooltipView = /** @class */ (function (_super) {
    ...
    CandleTooltipView.prototype.drawImp = function (ctx) {
        ...
        if (crosshair.kLineData !== undefined) {
            ...
            if (candleStyles.tooltip.showType === exports.TooltipShowType.Rect &&
                ...
                var top_1 = this._drawCandleStandardTooltip(ctx, dataList, paneId, bounding, crosshair, activeIconInfo, precision, dateTimeFormat, locale, customApi, candleStyles);
                this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIconInfo, indicators, customApi, bounding, indicatorStyles, top_1);
            }
            else if (candleStyles.tooltip.showType === exports.TooltipShowType.Rect &&
                indicatorStyles.tooltip.showType === exports.TooltipShowType.Standard) {
                var top_2 = this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIconInfo, indicators, customApi, bounding, indicatorStyles, 0);
                var isDrawCandleTooltip = this.isDrawTooltip(crosshair, candleStyles.tooltip);
                this._drawRectTooltip(ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, isDrawCandleTooltip, false, styles, top_2);
            }
            else {
                var top_3 = this._drawCandleStandardTooltip(ctx, dataList, paneId, bounding, crosshair, activeIconInfo, precision, dateTimeFormat, locale, customApi, candleStyles);
                var isDrawIndicatorTooltip = this.isDrawTooltip(crosshair, indicatorStyles.tooltip);
                this._drawRectTooltip(ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, false, isDrawIndicatorTooltip, styles, top_3);
            }
        }
    };
    CandleTooltipView.prototype._drawCandleStandardTooltip = function (ctx, dataList, paneId, bounding, crosshair, activeTooltipIconInfo, precision, dateTimeFormat, locale, customApi, styles) {
        var _a, _b, _c;
        var tooltipStyles = styles.tooltip;
        ...
        if (this.isDrawTooltip(crosshair, tooltipStyles)) {
            ...
            var values = this._getCandleTooltipData({ prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null, current: crosshair.kLineData, next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null }, precision, dateTimeFormat, locale, customApi, styles);
            var x = 0;
            var y = 0;
            var prevRowHeight = 0;
    ...
    CandleTooltipView.prototype._drawRectTooltip = function (ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, isDrawCandleTooltip, isDrawIndicatorTooltip, styles, top) {
        var _this = this;
        var _a, _b, _c, _d, _e;
        var candleStyles = styles.candle;
        var indicatorStyles = styles.indicator;
        ...
        if (isDrawCandleTooltip || isDrawIndicatorTooltip) {
            var dataIndex = (_a = crosshair.dataIndex) !== null && _a !== void 0 ? _a : 0;
            var candleTooltipDatas = this._getCandleTooltipData({ prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null, current: crosshair.kLineData, next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null }, precision, dateTimeFormat, locale, customApi, candleStyles);
            ...
            var _g = candleTooltipStyles.rect, rectPaddingLeft = _g.paddingLeft, rectPaddingRight_1 = _g.paddingRight, rectPaddingTop = _g.paddingTop, rectPaddingBottom = _g.paddingBottom, rectLeft = _g.offsetLeft, rectRight = _g.offsetRight, rectOffsetTop = _g.offsetTop, rectBorderSize_1 = _g.borderSize, rectBorderRadius = _g.borderRadius, rectBorderColor = _g.borderColor, rectBackgroundColor = _g.color;
            ...
            if (isDrawIndicatorTooltip) {
                ...
                indicators.forEach(function (indicator) {
                    var _a;
                    var tooltipDataValues = (_a = _this.getIndicatorTooltipData(dataList, crosshair, indicator, customApi, indicatorStyles).values) !== null && _a !== void 0 ? _a : [];
            ...
            if (rectWidth_1 !== 0 && rectHeight_1 !== 0) {
                ...
                var rectX_1;
                if (((_d = crosshair.realX) !== null && _d !== void 0 ? _d : 0) < centerX) {
                    rectX_1 = bounding.width - rectRight - rectWidth_1;
    ...
    CandleTooltipView.prototype._getCandleTooltipData = function (data, precision, dateTimeFormat, locale, customApi, styles) {
        var _a, _b, _c;
        var tooltipStyles = styles.tooltip;
        var textColor = tooltipStyles.text.color;
        var tooltipData = [];
        if (isFunction(tooltipStyles.custom)) {
            var labelValues = (_b = (_a = tooltipStyles.custom) === null || _a === void 0 ? void 0 : _a.call(tooltipStyles, data, styles)) !== null && _b !== void 0 ? _b : [];
            labelValues.forEach(function (_a) {
            ...
            tooltipData = [
                {
                    ...
                    value: { text: customApi.formatDate(dateTimeFormat, current.timestamp, 'YYYY-MM-DD HH:mm', exports.FormatDateType.Tooltip), color: textColor }
                }, {
                    ...
                    value: {
                        text: customApi.formatBigNumber(formatPrecision((_c = current.volume) !== null && _c !== void 0 ? _c : tooltipStyles.defaultValue, volumePrecision)),
                        color: textColor
                    }
                }
            ];
...
var OverlayYAxisView = /** @class */ (function (_super) {
    ...
    OverlayYAxisView.prototype.drawDefaultFigures = function (ctx, overlay, coordinates, bounding, precision, dateTimeFormat, customApi, defaultStyles, xAxis, yAxis, _hoverInstanceInfo, clickInstanceInfo) {
    ...
    OverlayYAxisView.prototype.getDefaultFigures = function (overlay, coordinates, bounding, precision, _dateTimeFormat, _customApi, _xAxis, yAxis, clickInstanceInfo) {
        var _a, _b;
        var figures = [];
        if (overlay.needDefaultYAxisFigure &&
            ...
            coordinates.forEach(function (coordinate, index) {
                ...
                if (point.value !== undefined) {
                    ...
                    var text = formatPrecision(point.value, precision.price);
    ...
    OverlayYAxisView.prototype.getFigures = function (overlay, coordinates, bounding, barSpace, precision, dateTimeFormat, defaultStyles, xAxis, yAxis) {
        var _a, _b;
        return (_b = (_a = overlay.createYAxisFigures) === null || _a === void 0 ? void 0 : _a.call(overlay, { overlay: overlay, coordinates: coordinates, bounding: bounding, barSpace: barSpace, precision: precision, dateTimeFormat: dateTimeFormat, defaultStyles: defaultStyles, xAxis: xAxis, yAxis: yAxis })) !== null && _b !== void 0 ? _b : [];
    };
...
var CrosshairHorizontalLabelView = /** @class */ (function (_super) {
    ...
    CrosshairHorizontalLabelView.prototype.checkPaneId = function (crosshair, paneId) {
...
var OverlayXAxisView = /** @class */ (function (_super) {
    ...
    OverlayXAxisView.prototype.getDefaultFigures = function (overlay, coordinates, bounding, _precision, dateTimeFormat, customApi, _xAxis, _yAxis, clickInstanceInfo) {
        var _a;
        var figures = [];
    ...
    OverlayXAxisView.prototype.getFigures = function (overlay, coordinates, bounding, barSpace, precision, dateTimeFormat, defaultStyles, xAxis, yAxis) {
        var _a, _b;
        return (_b = (_a = overlay.createXAxisFigures) === null || _a === void 0 ? void 0 : _a.call(overlay, { overlay: overlay, coordinates: coordinates, bounding: bounding, barSpace: barSpace, precision: precision, dateTimeFormat: dateTimeFormat, defaultStyles: defaultStyles, xAxis: xAxis, yAxis: yAxis })) !== null && _b !== void 0 ? _b : [];
    };
...
var CrosshairVerticalLabelView = /** @class */ (function (_super) {
    ...
    CrosshairVerticalLabelView.prototype.checkPaneId = function (crosshair) {
                ...
                case WidgetNameConstants.MAIN: {
                    ...
                    if (!consumed && this._startScrollCoordinate !== null) {
                        ...
                        if (this._prevYAxisExtremum !== null && !yAxis.getAutoCalcTickFlag()) {
                            var _f = this._prevYAxisExtremum, min = _f.min, max = _f.max, range = _f.range;
                            var distance_1;
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.applyNewData = function (dataList, more) {
        this._chartStore.clearDataList();
        this.applyMoreData(dataList, more);
    };
    ChartImp.prototype.applyMoreData = function (dataList, more) {
        var _this = this;
    ...
    ChartImp.prototype.createOverlay = function (value, paneId) {
        var overlay = isString(value) ? { name: value } : value;
        ...
        var id = this._chartStore.getOverlayStore().addInstance(overlay, paneId, appointPaneFlag);
        if (id === null) {
    ...
    ChartImp.prototype.scrollToRealTime = function (animationDuration) {
        ...
        var difBarCount = timeScaleStore.getOffsetRightBarCount() - timeScaleStore.getOffsetRightDistance() / barSpace;
...
function init(ds, options) {
    ...
    var chart = instances[(_a = dom.chartId) !== null && _a !== void 0 ? _a : ''];
    if (chart !== undefined) {
